...
Release evidence in this branch: 90 deterministic native-agent tests, 373
focused integration/normal-agent/i18n regression tests, full Ruff check/format,
and no external model credentials. The final repository-wide run reports 7,274
